...
@riverpod
StatisticsController statisticsController(final StatisticsControllerRef ref) => ref.watch(
    statisticsDefaultControllerProvider.notifier
);


@riverpod
StatisticsModel statisticsModel(final StatisticsModelRef ref) => ref.watch(
