...
void main() async {
  ...
  testWidgets('Shows onboarding statistics view', (tester) async {
    await tester.pumpWidget(EasyLocalization(
        ...
        child: UncontrolledProviderScope(
          ...
          child: const MyAppMock(child: OnboardingStatistics()),
        )));
    await tester.pump();

    expect(
        find.text(LocaleKeys.onboardingStatisticsTitle.tr()), findsOneWidget);
    expect(find.text(LocaleKeys.onboardingStatisticsSubtitle.tr()),
        findsOneWidget);
    expect(
